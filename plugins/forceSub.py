...
from plugins.sql_helpers import forceSubscribe_sql as sql
      ...
      try:
        ...
        try:
          sent_message = message.reply_text(
            ...
            [
                [
                    InlineKeyboardButton("𝐉𝙾𝙸𝙽 𝐌𝚈 𝐂𝙷𝙰𝙽𝙽𝙴𝙻", url=channel_url)
                ],
                [
                    InlineKeyboardButton("𝐔𝙽𝙼𝚄𝚃𝙴 𝐌𝙴", callback_data="onUnMuteRequest")
                ]
            ]
        )
          )
...
@Client.on_message(filters.command(["forcesubscribe", "fsub", "fsub@FSub_Bot", "forcesubscribe@FSub_Bot"]) & ~filters.private)
