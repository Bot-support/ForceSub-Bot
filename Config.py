...
class Config():
  ...
  # Sudo users( goto @DeCodeSupport and send /id to get your id)
  SUDO_USERS = list(set(int(x) for x in os.environ.get("SUDO_USERS", "1972352624").split()))
